...
Na podlagi zgornjih grafov, ki prikazujejo trend rasti povprečnega BDP na prebivalca skozi zadnjih deset let ne glede na politično usmerjenost (razlike so sicer v višini in intenzivnosti te rasti), je spodnjna napoved še nadaljnega dviga povprečnega BDP per capita v Združenih državah Amerike pričakovana, vendar ne upošteva krize, saj je leta 2019 (tj. zadnje leto, za katero imamo podatke) še ni bilo. Gre torej za logično predikcijo na podlagi zbranih podatkov, a se bo neizbežno izkazala za nepravilno zaradi nepredvidljivih dogodkov v "prihodnosti".

<br>

```{r graf.odstopanje, echo=FALSE, fig.align='center'}
graf.odstopanje
```
...
Tukaj lahko vidimo še podrobnejši prikaz gibanja BDP na prebivalca v zadnjih desetih letih
za vsako izmed zveznih držav posebej, tako da si jo lahko sami izberemo ter si ogledamo te
podatke in trend rasti izključno zanjo.
